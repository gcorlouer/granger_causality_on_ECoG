...
from src.plotting_lib import (
    plot_single_trial_pfc,
    plot_single_trial_gfc,
    info_flow_stat,
)
...
full_stim_multi_pfc(
    fc, cohort, args, F="pGC", vmin=-vmax, vmax=vmax, rotation=90, tau_x=0.5, tau_y=0.8
)
...
full_stim_multi_pfc(
    fc, cohort, args, F="pMI", vmin=-vmax, vmax=vmax, rotation=90, tau_x=0.5, tau_y=0.8
)
plt.show()
# %% Plot multitrial groupwise GC
vmin = 3
full_stim_multi_gfc(
    fc, cohort, args, F="gGC", vmin=vmin, vmax=-vmin, rotation=90, tau_x=0.5, tau_y=0.8
)

# %% Plot  multitrial groupwise MI
vmin = 4
full_stim_multi_gfc(
    fc, cohort, args, F="gMI", vmin=vmin, vmax=-vmin, rotation=90, tau_x=0.5, tau_y=0.8
)
