...
function [S_brain,H,SUMAsrf] = plot_FS_brain_example_code(initials,S_brain)

if isempty(initials); initials = 'fsaverage'; end
...
meshDir=fullfile(S_brain.meshdir,initials);
...
if ismember(S_brain.plotsurf,{'flat', 'inflated'})
    load('D:\plot_brain\default_freesrufer_surface\SUMA_default.mat');
else
    load('D:\plot_brain\default_freesrufer_surface\SUMA_pial_blank.mat');
  %  load('D:\plot_brain\default_freesrufer_surface\SUMA_DKatlas.mat');
end
